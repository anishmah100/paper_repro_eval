# Review guide: Visual Offline World-Model Control
...
Primary metric: Realized robust control score. Declared tiebreaks: Higher landing/docking success, then lower fuel use.

...
4. Implement private measurements for: render-correctness, estimator-validity, equal-time-quality, mis-variance, throughput.
...
Winner rule: Highest qualifying equal-time image-quality score across hidden scenes wins.

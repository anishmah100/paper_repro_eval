# Review guide: Progressive Competitive Path Tracer
...
Primary metric: Equal-time render quality. Declared tiebreaks: Lower measured bias, then higher samples per second.

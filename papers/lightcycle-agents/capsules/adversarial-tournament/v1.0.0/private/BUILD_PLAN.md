...
4. Implement private measurements for: bot-protocol, fixed-opponent-field, cross-agent-tournament, reliability.
...
Winner rule: Highest qualifying round-robin tournament score wins after paired sides and hidden maps.

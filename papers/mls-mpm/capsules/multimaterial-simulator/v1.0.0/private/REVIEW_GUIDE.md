# Review guide: Competitive Multi-Material MLS-MPM Simulator
...
Primary metric: Physical fidelity and scene coverage. Declared tiebreaks: Higher hardest-material level, then simulation throughput.

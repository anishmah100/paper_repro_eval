...
4. Implement private measurements for: agent-protocol, control-ladder, robustness, control-efficiency.
...
Winner rule: Highest qualifying aggregate return across the hidden control ladder wins.

# Review guide: Progressive Multi-Pole Control
...
Primary metric: Robust multi-pole return. Declared tiebreaks: Higher hardest-level success, then lower control energy.

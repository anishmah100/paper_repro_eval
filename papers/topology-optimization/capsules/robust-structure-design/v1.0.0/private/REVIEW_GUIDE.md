# Review guide: Robust Topology-Optimization Challenge
...
Primary metric: Robust constrained compliance. Declared tiebreaks: Lower worst-case compliance, then faster solve.

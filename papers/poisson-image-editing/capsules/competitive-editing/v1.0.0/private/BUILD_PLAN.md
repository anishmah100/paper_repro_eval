...
4. Implement private measurements for: build-and-artifacts, pde-correctness, hidden-edit-quality, edge-case-robustness, efficiency.
...
Winner rule: Highest qualifying hidden-case quality wins; boundary residual and runtime break ties.
